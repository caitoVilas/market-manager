package com.mm.marketmanager.utils.logs;

/**
 * Utility class for logging messages with different severity levels.
 * Provides methods to log informational, error, and warning messages
 * with appropriate color coding for better visibility in the console.
 *
 * @author caito
 *
 */
